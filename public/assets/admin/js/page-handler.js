document.addEventListener('DOMContentLoaded', () => {
    ...
    function initModals() {
        ...
        modals.forEach(modal => {
            ...
            // Only target explicit close buttons, not all type="button" buttons
            ...
            if (form) {
                form.addEventListener('submit', (e) => {
                    ...
                    // Process form data (actual processing should depend on the form type)
                    // This is a placeholder
                    setTimeout(() => {
                        showToast(`${entityType.charAt(0).toUpperCase() + entityType.slice(1)} saved successfully!`, 'success');
                        closeModalWithAnimation(modal);
                    }, 300);
                });
            }
